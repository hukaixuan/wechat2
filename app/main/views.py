...
def index():
	...
	if request.method == 'POST':
		...
		to_send = jsonify(key='195673593543a59a16e1777a811593b6', info=content,
				userid=fromUserName)
		resp = requests.post(json=to_send)
...
@main.route('/i', methods=['GET', 'POST'])			# main 为在package main下的init创建的blueprint
def index2():
	form = PostForm()
